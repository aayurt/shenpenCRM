...
export class PostControllerBase {
  ...
  async findManyAuthor(
    ...
    const query = plainToClass(AuthorFindManyArgs, request.query);
    const results = await this.service.findAuthor(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Delete("/:id/author")
  @nestAccessControl.UseRoles({
    resource: "Post",
    action: "update",
    possession: "any",
  })
  async disconnectAuthor(
    @common.Param() params: PostWhereUniqueInput,
    @common.Body() body: AuthorWhereUniqueInput[]
  ): Promise<void> {
    const data = {
